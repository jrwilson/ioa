...
uint32_t port_allocator_port_set_count (port_allocator_t* port_allocator);
...
uint32_t port_allocator_input_count (port_allocator_t* port_allocator, uint32_t idx);
uint32_t port_allocator_output_count (port_allocator_t* port_allocator, uint32_t idx);
