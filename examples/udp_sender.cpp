...
public:
  ...
  {
    ioa::automaton_helper<ioa::udp_sender_automaton>* sender = new ioa::automaton_helper<ioa::udp_sender_automaton> (this, ioa::make_generator<ioa::udp_sender_automaton> ());
