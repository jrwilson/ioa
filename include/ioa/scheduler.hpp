...
namespace ioa {
  ...
  void schedule (M I::*member_ptr) {
    assert (scheduler != 0);
    scheduler->schedule (make_action_runnable (make_action (automaton_handle<I> (get_current_aid ()), member_ptr)));
  }
  ...
  void schedule (M I::*member_ptr,
    ...
    assert (scheduler != 0);
    scheduler->schedule (make_action_runnable (make_action (automaton_handle<I> (get_current_aid ()), member_ptr, param)));
  }
  ...
  void schedule_after (M I::*member_ptr,
		       const time& offset) {
    assert (scheduler != 0);
    scheduler->schedule_after (make_action_runnable (make_action (automaton_handle<I> (get_current_aid ()), member_ptr)), offset);
  }
  ...
  void schedule_after (M I::*member_ptr,
		       ...
		       const time& offset) {
    assert (scheduler != 0);
    scheduler->schedule_after (make_action_runnable (make_action (automaton_handle<I> (get_current_aid ()), member_ptr, param)), offset);
  }
  ...
  void schedule_read_ready (M I::*member_ptr,
			    int fd) {
    assert (scheduler != 0);
    scheduler->schedule_read_ready (make_action_runnable (make_action (automaton_handle<I> (get_current_aid ()), member_ptr)), fd);
  }
  ...
  void schedule_read_ready (M I::*member_ptr,
			    ...
			    int fd) {
    assert (scheduler != 0);
    scheduler->schedule_read_ready (make_action_runnable (make_action (automaton_handle<I> (get_current_aid ()), member_ptr, param)), fd);
  }
  ...
  void schedule_write_ready (M I::*member_ptr,
			     int fd) {
    assert (scheduler != 0);
    scheduler->schedule_write_ready (make_action_runnable (make_action (automaton_handle<I> (get_current_aid ()), member_ptr)), fd);
  }
