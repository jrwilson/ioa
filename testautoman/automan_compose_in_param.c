...
static void automaton_input (void* state, void* param, bid_t bid);
...
static void
automaton_input (void* state, void* param, bid_t bid)
{
...
static const input_t automaton_inputs[] = {
  automaton_input,
  NULL
};
