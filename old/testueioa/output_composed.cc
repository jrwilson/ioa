...
static void*
input_composed_create (const void* arg)
{
  input_composed_t* input_composed = (input_composed_t*)malloc (sizeof (input_composed_t));
...
{
  input_composed_t* input_composed = (input_composed_t*)state;
...
descriptor_t input_composed_descriptor = {
  input_composed_create,
  input_composed_system_input,
  input_composed_system_output,
  NULL,
  NULL,
  NULL,
  NULL,
