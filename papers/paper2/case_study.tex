...
Our implementation of the asynchronous LCR automaton is also freely available as open-source\footnote{\url{github.com/jrwilson/ioa/blob/master/examples/asynch_lcr_automaton.hpp}}.
