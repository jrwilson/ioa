...
To illustrate this issue consider the problem of providing a graphical user interface using Java Swing~\cite{eckstein1998java} aopt a middleware based on the Reactor or Proactor design pattern~\cite{schmidt2000pattern}.
