...
While a number of component frameworks for distributed systems have been developed, each framework uses the same basic technologies:  threads, event loops, or a combination of both.
