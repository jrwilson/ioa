...
The goal of this evaluation is (1) to show that concurrent execution is indeed possible and (2) to show that the degree of exploitable concurrency depends on the interactions of the I/O automata comprising the system and the overhead of the system.
To test concurrent execution, we execute a system whose actions can be configured to span the range from having no independent actions to having all independent actions.
