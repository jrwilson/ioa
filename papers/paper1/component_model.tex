...
We then describe extensions to support semantics for dynamic systems, i.e., systems whose set of constituent automata changes over time.
...
Graphically, an arrow originating in one component must terminate in another component as Figure~\ref{sys_model} illustrates.
