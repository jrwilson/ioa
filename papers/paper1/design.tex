...
The services provided by the base class are indicated by the Base Automaton layer of Figure~\ref{framework_architecture}.
...
Since concurrent access to the model is allowed, the module implementing the model must be thread-safe.
