...
All user automata inherit from a common Base Automaton class that provides facilities for asynchronously creating and destroying child automata and bindings.
% The services provided by that common base class are indicated by the Base Automaton shown in Figure~\ref{framework_architecture}.
...
Instead, an Automaton Manager provides a common higher-level interface for asynchronously managing a single child automaton using the services of the Base Automaton class.
