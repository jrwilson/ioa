...
unvalued_unparameterized_output_action ()
{
  ...
  ioa::action_runnable<automaton1, automaton1::uv_up_output_action> runnable (tss, shared_mutex, automaton_set, binding_set, instance, mutex, h, &automaton1::uv_up_output);
...
unvalued_parameterized_output_action ()
{
  ...
  ioa::action_runnable<automaton1, automaton1::uv_p_output_action> runnable (tss, shared_mutex, automaton_set, binding_set, instance, mutex, h, &automaton1::uv_p_output, parameter);
  mu_assert (executor == runnable.get_action ());
...
unvalued_auto_parameterized_output_action ()
{
  ...
  ioa::action_runnable<automaton1, automaton1::uv_ap_output_action> runnable (tss, shared_mutex, automaton_set, binding_set, instance, mutex, h, &automaton1::uv_ap_output, input_action1.get_aid ());
  mu_assert (executor == runnable.get_action ());
...
valued_unparameterized_output_action ()
{
  ...
  ioa::action_runnable<automaton1, automaton1::v_up_output_action> runnable (tss, shared_mutex, automaton_set, binding_set, instance, mutex, h, &automaton1::v_up_output);
  mu_assert (executor == runnable.get_action ());
...
valued_parameterized_output_action ()
{
  ...
  ioa::action_runnable<automaton1, automaton1::v_p_output_action> runnable (tss, shared_mutex, automaton_set, binding_set, instance, mutex, h, &automaton1::v_p_output, parameter);
  mu_assert (executor == runnable.get_action ());
...
valued_auto_parameterized_output_action ()
{
  ...
  ioa::action_runnable<automaton1, automaton1::v_ap_output_action> runnable (tss, shared_mutex, automaton_set, binding_set, instance, mutex, h, &automaton1::v_ap_output, input_action1.get_aid ());
  mu_assert (executor == runnable.get_action ());
...
unparameterized_internal_action ()
{
  ...
  ioa::action_runnable<automaton1, automaton1::up_internal_action> runnable (tss, shared_mutex, automaton_set, instance, mutex, h, &automaton1::up_internal);
  mu_assert (executor == runnable.get_action ());
...
parameterized_internal_action ()
{
  ...
  ioa::action_runnable<automaton1, automaton1::p_internal_action> runnable (tss, shared_mutex, automaton_set, instance, mutex, h, &automaton1::p_internal, parameter);
  mu_assert (executor == runnable.get_action ());
